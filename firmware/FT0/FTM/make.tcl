...
set project_name "FIT_TESTMODULE_v1"
...
set files [list \
 ...
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/ipbus_trans_decl.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_build_arp.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_build_ping.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_ipaddr_block.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_build_payload.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_build_resend.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_build_status.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_status_buffer.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_byte_sum.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_do_rx_reset.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_packet_parser.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_rxram_mux.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_dualportram.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_buffer_selector.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_rxram_shim.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_dualportram_rx.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_rxtransactor_if_simple.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_dualportram_tx.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_tx_mux.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_txtransactor_if_simple.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_clock_crossing_if.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/udp_if_flat.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/transactor_if.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/transactor_sm.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/transactor_cfg.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/transactor.vhd" ]\
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_core/ipbus_ctrl.vhd" ]\
 ...
 [file normalize "${origin_dir}/hdl/ipbus/ipbus_slaves/ipbus_spi.vhd" ]\
