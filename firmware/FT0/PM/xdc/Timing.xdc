...
# RXDATA_CLKSync ----------------------------------
set_max_delay -datapath_only -from [get_clocks RXDataCLK] -to [get_cells {FitGbtPrg/RxData_ClkSync_comp/RX_DATA_sysclk_reg[*] FitGbtPrg/RxData_ClkSync_comp/RX_IS_DATA_sysclk_reg}] 3.000
